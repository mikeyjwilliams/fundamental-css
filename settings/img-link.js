...
function imgLink() {
    return merge(
        ...
        src(
            [
                `${source.images}/**/*.{svg,png,gif,jpg,jpeg,webp}`,
                `${source.components}/**/*.{svg,png,gif,jpg,jpeg,webp}`,
            ],
            {
        ...
        src(
            [
                `${source.images}/**/*.{png,gif,jpg,jpeg,webp}`,
                `${source.components}/**/*.{png,gif,jpg,jpeg,webp}`,
            ],
            {
                since: lastRun(imgLink),
            }
